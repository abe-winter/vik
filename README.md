...
vikunja clients for agents:
- (old) `vik` CLI with skill markdown
- (new) `vik` plugin for the omp.sh harness

Note: a lot of the below describes the old CLI. I think the new install instruction is:
